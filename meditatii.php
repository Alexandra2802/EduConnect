      ...
      <div class="main">
        <form action="insert.php" method="POST" enctype="multipart/form-data" >
          <div class="input-container">
            ...
            <input type="text" name="subject" class="table-input" id="subject"><br>
            <label for="duration">DURATA</label>
            <input type="text" name="duration" class="table-input" id="duration"><br>
            <label for="price">PRET</label>
            <input type="text" name="price" class="table-input" id="price"><br>
            <label for="contact">CONTACT</label>
            <input type="text" name="contact" class="table-input" id="contact"><br>
            <br>
            <button type="submit" name="upload" class="add-btn">Adauga</button>
          </div>       
        </form>
      </div>
           </div>
        ...
        <table class="table" style="color:white">
          <thead>
            <tr>
              ...
              <th scope="col" colspan="2" style="text-align:center;">Actiuni</th>
            </tr>
          </thead>
          <tbody id="table-body">
            <?php
